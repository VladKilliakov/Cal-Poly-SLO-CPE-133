...
HD_PWD='C:/Users/nmah/Documents/GitHub/Cal-Poly-SLO-CPE-133/Final_Project_1/Final_Project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fourier_Func_Gen.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Fourier_Func_Gen.tcl
