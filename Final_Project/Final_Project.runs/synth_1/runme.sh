...
HD_PWD='C:/Users/nmah/Desktop/Final_Project/Final_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Clock_Divider.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Clock_Divider.tcl
